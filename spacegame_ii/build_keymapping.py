...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "keymapping.py"
 
        #Name of program
        self.project_name = "Keymapper Util"
        ...
        #Description
        self.project_description = "Use this to setup the SpaceGame key bindings"
    ...
    def run(self):
        ...
        try:
            os.remove("keymapping.exe")
        except BaseException as e:
            print "Can't remove spacegame.exe"
            print e
        shutil.copyfile("dist/keymapping.exe", "keymapping.exe")
